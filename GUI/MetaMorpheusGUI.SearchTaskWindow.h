...
namespace TaskLayer { class SearchTask; }
...
namespace MetaMorpheusGUI { class ModTypeForGrid; }
...
namespace MetaMorpheusGUI
{
	...
	/// </summary>
	class SearchTaskWindow : public Window
	{
	private:
		SearchTask *privateTheTask;
		...
		ObservableCollection<ModTypeForGrid*> *const ModSelectionGridItems = new ObservableCollection<ModTypeForGrid*>();

	public:
		virtual ~SearchTaskWindow()
		{
			...
			delete ModSelectionGridItems;
		}

		SearchTaskWindow();

		SearchTaskWindow(SearchTask *task);

		SearchTask *getTheTask() const;
		void setTheTask(SearchTask *value);
...
//
//			DigestionParams digestionParamsToSave = new DigestionParams(protease: protease.Name, maxMissedCleavages: maxMissedCleavages, minPeptideLength: minPeptideLengthValue, maxPeptideLength: maxPeptideLengthValue, maxModificationIsoforms: maxModificationIsoformsValue, initiatorMethionineBehavior: initiatorMethionineBehavior, maxModsForPeptides: maxModsForPeptideValue, searchModeType: searchModeType, fragmentationTerminus: fragmentationTerminus);
//
...
//				try
//				{
//					MassDiffAcceptor customMassDiffAcceptor = SearchTask.GetMassDiffAcceptor(nullptr, MassDiffAcceptorType.Custom, customkMdacTextBox.Text);
//				}
//				catch (Exception ex)
//				{
...
//			if (TheTask.SearchParameters.SearchType == SearchType.Classic && (TheTask.SearchParameters.MassDiffAcceptorType == MassDiffAcceptorType.ModOpen || TheTask.SearchParameters.MassDiffAcceptorType == MassDiffAcceptorType.Open))
//			{
