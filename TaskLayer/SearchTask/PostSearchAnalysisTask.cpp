    ...
    void PostSearchAnalysisTask::DoMassDifferenceLocalizationAnalysis()
    {
        if (getParameters()->getSearchParameters()->getDoLocalizationAnalysis())
        {
                 ...
                 spectraFileIndex++)
            {
                ...
                std::vector<std::string> svec = {getParameters()->getSearchTaskId(), "Individual Spectra Files", origDataFile};
                ...
                std::vector<std::string> svec3 = {getParameters()->getSearchTaskId(), "Individual Spectra Files", origDataFile};
        ...
        auto tpmpsms2 = getParameters()->getAllPsms();
        std::vector<std::string> svec4 = {getParameters()->getSearchTaskId()};
        ModificationAnalysisEngine tempVar3(tmppsms2, getCommonParameters(), svec4);
        (&tempVar3)->Run();
    }
