...
//C# TO C++ CONVERTER TODO TASK: A 'delete psmCrossSingle' statement was not added since psmCrossSingle was passed to a method or constructor. Handle memory management manually.
				}
				// Deadend Peptide
...
//C# TO C++ CONVERTER TODO TASK: A 'delete localizedBeta' statement was not added since localizedBeta was assigned to another object. Handle memory management manually.
//C# TO C++ CONVERTER TODO TASK: A 'delete localizedAlpha' statement was not added since localizedAlpha was assigned to an outer scope variable. Handle memory management manually.
				}
			}
...
//C# TO C++ CONVERTER TODO TASK: A 'delete localizedPeptide' statement was not added since localizedPeptide was assigned to an outer scope variable. Handle memory management manually.
			}
