...
namespace EngineLayer
{
    namespace Indexing
    {
        ...
        std::string IndexingEngine::ToString()
        {
            ...
            sb->appendLine("protease: " + commonParameters->getDigestionParams()->getProtease());
            sb->appendLine("initiatorMethionineBehavior: " + commonParameters->getDigestionParams()->getInitiatorMethionineBehavior());
            ...
            sb->appendLine("digestionTerminus: " + commonParameters->getDigestionParams()->getFragmentationTerminus());
            sb->appendLine("maxModsForEachPeptide: " + commonParameters->getDigestionParams()->getMaxModsForPeptide());
            sb->appendLine("cleavageSpecificity: " + commonParameters->getDigestionParams()->getSearchModeType());
            sb->appendLine("specificProtease: " + commonParameters->getDigestionParams()->getSpecificProtease());
        ...
        MetaMorpheusEngineResults *IndexingEngine::RunSpecific()
        {
            ...
            for ( int i = 0; i < (int)ProteinList.size(); i++ ) {
                progress++;
                globalesPeptides.AddRange(ProteinList[i]->Digest(commonParameters->getDigestionParams(),
                                                                FixedModifications, VariableModifications));
